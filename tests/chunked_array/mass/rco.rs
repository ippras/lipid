...
mod expected {
    ...
    pub(super) const C16C9: f64 = 237.2218;
    pub(super) const C16T9: f64 = 237.2218;
    pub(super) const C17: f64 = 253.2531;
    pub(super) const C18: f64 = 267.2688;
    pub(super) const C18C9: f64 = 265.2531;
    pub(super) const C18T9: f64 = 265.2531;
    pub(super) const C18C9C12: f64 = 263.2375;
    pub(super) const C18C6C9C12: f64 = 261.2218;
    pub(super) const C18C8T10C12: f64 = 261.2218;
    pub(super) const C18C9C12C15: f64 = 261.2218;
    pub(super) const C18C9T11T13: f64 = 261.2218;
    pub(super) const C18T9T11C13: f64 = 261.2218;
    pub(super) const C18T9T11T13: f64 = 261.2218;
    pub(super) const C18C6C9C12C15: f64 = 259.2062;
    pub(super) const C19: f64 = 281.2844;
    pub(super) const C20: f64 = 295.3001;
    pub(super) const C20C9: f64 = 293.2844;
    pub(super) const C20C11: f64 = 293.2844;
    pub(super) const C20C11C14: f64 = 291.2688;
    pub(super) const C20C5C8C11: f64 = 289.2531;
    pub(super) const C20C8C11C14: f64 = 289.2531;
    pub(super) const C20C11C14C17: f64 = 289.2531;
    pub(super) const C20C5C8C11C14: f64 = 287.2375;
    pub(super) const C20C8C11C14C17: f64 = 287.2375;
    pub(super) const C20C5C8C11C14C17: f64 = 285.2218;
    pub(super) const C21: f64 = 309.3157;
    pub(super) const C22: f64 = 323.3314;
    pub(super) const C22C13: f64 = 321.3157;
    pub(super) const C22C13C16: f64 = 319.3001;
    pub(super) const C22C5C13C16: f64 = 317.2844;
    pub(super) const C22C7C10C13C16: f64 = 315.2688;
    pub(super) const C22C7C10C13C16C19: f64 = 313.2531;
    pub(super) const C22C4C7C10C13C16C19: f64 = 311.2375;
    pub(super) const C23: f64 = 337.3470;
    pub(super) const C24: f64 = 351.3627;
    pub(super) const C24C15: f64 = 349.3470;
    pub(super) const C24C15C18: f64 = 347.3314;
    pub(super) const C24C12C15C18: f64 = 345.3157;
    pub(super) const C24C9C12C15C18: f64 = 343.3001;
    pub(super) const C24C6C9C12C15C18: f64 = 341.2844;
    pub(super) const C24C6C9C12C15C18C21: f64 = 339.2688;
    pub(super) const C25: f64 = 365.3783;
    pub(super) const C26: f64 = 379.3940;
    pub(super) const C26C17: f64 = 377.3783;
    ...
    pub(super) const C30C21: f64 = 433.4409;
