...
macro_rules! check {
    ($identifier:ident) => {{
        ...
        let is_cis = fatty_acid.is_cis();
        assert!(is_cis == Some(expected::$identifier));
    }};
}
...
mod expected {
    ...
    pub(super) const C16DT9: bool = false;
    pub(super) const C17: bool = false;
    pub(super) const C18: bool = false;
    pub(super) const C18DC9: bool = true;
    pub(super) const C18DT9: bool = false;
    pub(super) const C18DC9DC12: bool = true;
    pub(super) const C18DC6DC9DC12: bool = true;
    pub(super) const C18DC8DT10DC12: bool = false;
    pub(super) const C18DC9DC12DC15: bool = true;
    ...
    pub(super) const C18DC6DC9DC12DC15: bool = true;
    ...
    pub(super) const C20DC11DC14: bool = true;
    pub(super) const C20DC5DC8DC11: bool = true;
    pub(super) const C20DC8DC11DC14: bool = true;
    pub(super) const C20DC11DC14DC17: bool = true;
    pub(super) const C20DC5DC8DC11DC14: bool = true;
    pub(super) const C20DC8DC11DC14DC17: bool = true;
    pub(super) const C20DC5DC8DC11DC14DC17: bool = true;
    pub(super) const C21: bool = false;
    pub(super) const C22: bool = false;
    pub(super) const C22DC13: bool = true;
    pub(super) const C22DC13DC16: bool = true;
    pub(super) const C22DC5DC13DC16: bool = true;
    pub(super) const C22DC7DC10DC13DC16: bool = true;
    pub(super) const C22DC7DC10DC13DC16DC19: bool = true;
    pub(super) const C22DC4DC7DC10DC13DC16DC19: bool = true;
    pub(super) const C23: bool = false;
    pub(super) const C24: bool = false;
    pub(super) const C24DC15: bool = true;
    pub(super) const C24DC15DC18: bool = true;
    pub(super) const C24DC12DC15DC18: bool = true;
    pub(super) const C24DC9DC12DC15DC18: bool = true;
    pub(super) const C24DC6DC9DC12DC15DC18: bool = true;
    pub(super) const C24DC6DC9DC12DC15DC18DC21: bool = true;
