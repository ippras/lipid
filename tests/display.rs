...
fn fatty_acid<const N: usize>(
    ...
    Ok(FattyAcidChunked::try_from(bounds)?
        .display(options)
        .to_string())
}
...
mod common {
    ...
    fn delta() -> PolarsResult<()> {
        ...
        let c22u6dc4dc7dc10dc13dc16dc19 = fatty_acid(&C22DC4DC7DC10DC13DC16DC19)?;
