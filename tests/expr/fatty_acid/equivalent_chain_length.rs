...
fn c16dc9() -> PolarsResult<()> {
    check!(C16C9, 16.0 + (13.0 - 12.0) / (15.0 - 12.0));
    Ok(())
}

#[test]
fn c16dt9() -> PolarsResult<()> {
    check!(C16T9, 16.0 + (14.0 - 12.0) / (15.0 - 12.0));
    Ok(())
}
...
fn c18dc9() -> PolarsResult<()> {
    check!(C18C9, 18.0 + (17.0 - 16.0) / (27.0 - 16.0));
    Ok(())
}

#[test]
fn c18dt9() -> PolarsResult<()> {
    check!(C18T9, 18.0 + (18.0 - 16.0) / (27.0 - 16.0));
    Ok(())
}

#[test]
fn c18dc9dc12() -> PolarsResult<()> {
    check!(C18C9C12, 18.0 + (19.0 - 16.0) / (27.0 - 16.0));
    Ok(())
}

#[test]
fn c18dc6dc9dc12() -> PolarsResult<()> {
    check!(C18C6C9C12, 18.0 + (20.0 - 16.0) / (27.0 - 16.0));
    Ok(())
}

#[test]
fn c18dc8dt10dc12() -> PolarsResult<()> {
    check!(C18C8T10C12, 18.0 + (21.0 - 16.0) / (27.0 - 16.0));
    Ok(())
}

#[test]
fn c18dc9dc12dc15() -> PolarsResult<()> {
    check!(C18C9C12C15, 18.0 + (22.0 - 16.0) / (27.0 - 16.0));
    Ok(())
}

#[test]
fn c18dc9dt11dt13() -> PolarsResult<()> {
    check!(C18C9T11T13, 18.0 + (23.0 - 16.0) / (27.0 - 16.0));
    Ok(())
}

#[test]
fn c18dt9dt11dc13() -> PolarsResult<()> {
    check!(C18T9T11C13, 18.0 + (24.0 - 16.0) / (27.0 - 16.0));
    Ok(())
}

#[test]
fn c18dt9dt11dt13() -> PolarsResult<()> {
    check!(C18T9T11T13, 18.0 + (25.0 - 16.0) / (27.0 - 16.0));
    Ok(())
}

#[test]
fn c18dc6dc9dc12dc15() -> PolarsResult<()> {
    check!(C18C6C9C12C15, 18.0 + (26.0 - 16.0) / (27.0 - 16.0));
    Ok(())
}
...
fn c20dc9() -> PolarsResult<()> {
    check!(C20C9, 20.0 + (29.0 - 28.0) / (38.0 - 28.0));
    Ok(())
}

#[test]
fn c20dc11() -> PolarsResult<()> {
    check!(C20C11, 20.0 + (30.0 - 28.0) / (38.0 - 28.0));
    Ok(())
}

#[test]
fn c20dc11dc14() -> PolarsResult<()> {
    check!(C20C11C14, 20.0 + (31.0 - 28.0) / (38.0 - 28.0));
    Ok(())
}

#[test]
fn c20dc5dc8dc11() -> PolarsResult<()> {
    check!(C20C5C8C11, 20.0 + (32.0 - 28.0) / (38.0 - 28.0));
    Ok(())
}

#[test]
fn c20dc8dc11dc14() -> PolarsResult<()> {
    check!(C20C8C11C14, 20.0 + (33.0 - 28.0) / (38.0 - 28.0));
    Ok(())
}

#[test]
fn c20dc11dc14dc17() -> PolarsResult<()> {
    check!(C20C11C14C17, 20.0 + (34.0 - 28.0) / (38.0 - 28.0));
    Ok(())
}

#[test]
fn c20dc5dc8dc11dc14() -> PolarsResult<()> {
    check!(C20C5C8C11C14, 20.0 + (35.0 - 28.0) / (38.0 - 28.0));
    Ok(())
}

#[test]
fn c20dc8dc11dc14dc17() -> PolarsResult<()> {
    check!(C20C8C11C14C17, 20.0 + (36.0 - 28.0) / (38.0 - 28.0));
    Ok(())
}

#[test]
fn c20dc5dc8dc11dc14dc17() -> PolarsResult<()> {
    check!(C20C5C8C11C14C17, 20.0 + (37.0 - 28.0) / (38.0 - 28.0));
    Ok(())
}
...
fn c22dc13() -> PolarsResult<()> {
    check!(C22C13, 22.0 + (40.0 - 39.0) / (46.0 - 39.0));
    Ok(())
}

#[test]
fn c22dc13dc16() -> PolarsResult<()> {
    check!(C22C13C16, 22.0 + (41.0 - 39.0) / (46.0 - 39.0));
    Ok(())
}

#[test]
fn c22dc5dc13dc16() -> PolarsResult<()> {
    check!(C22C5C13C16, 22.0 + (42.0 - 39.0) / (46.0 - 39.0));
    Ok(())
}

#[test]
fn c22dc7dc10dc13dc16() -> PolarsResult<()> {
    check!(C22C7C10C13C16, 22.0 + (43.0 - 39.0) / (46.0 - 39.0));
    Ok(())
}

#[test]
fn c22dc7dc10dc13dc16dc19() -> PolarsResult<()> {
    check!(C22C7C10C13C16C19, 22.0 + (44.0 - 39.0) / (46.0 - 39.0));
    Ok(())
}
...
fn c24dc15() -> PolarsResult<()> {
    check!(C24C15, 24.0 + (48.0 - 47.0) / (54.0 - 47.0));
    Ok(())
}

#[test]
fn c24dc15dc18() -> PolarsResult<()> {
    check!(C24C15C18, 24.0 + (49.0 - 47.0) / (54.0 - 47.0));
    Ok(())
}

#[test]
fn c24dc12dc15dc18() -> PolarsResult<()> {
    check!(C24C12C15C18, 24.0 + (50.0 - 47.0) / (54.0 - 47.0));
    Ok(())
}

#[test]
fn c24dc9dc12dc15dc18() -> PolarsResult<()> {
    check!(C24C9C12C15C18, 24.0 + (51.0 - 47.0) / (54.0 - 47.0));
    Ok(())
}

#[test]
fn c24dc6dc9dc12dc15dc18() -> PolarsResult<()> {
    check!(C24C6C9C12C15C18, 24.0 + (52.0 - 47.0) / (54.0 - 47.0));
    Ok(())
}
...
fn c26dc17() -> PolarsResult<()> {
    check!(C26C17, 26.0 + (56.0 - 55.0) / (57.0 - 55.0));
    Ok(())
}
...
fn c30dc21() -> PolarsResult<()> {
    check!(C30C21, 30.0 + (61.0 - 60.0) / (62.0 - 60.0));
    Ok(())
}
