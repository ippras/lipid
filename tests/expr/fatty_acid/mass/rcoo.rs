...
fn c16dc9() -> PolarsResult<()> {
    check!(C16C9, 253.2168);
    Ok(())
}

#[test]
fn c16dt9() -> PolarsResult<()> {
    check!(C16T9, 253.2168);
    Ok(())
}
