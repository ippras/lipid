...
fn mass(data_frame: DataFrame) -> PolarsResult<f64> {
    let data_frame = data_frame
        .lazy()
        .select([col("FattyAcid").fatty_acid().rcooch3().mass(None).round(4)])
        .collect()?;
...
mod r#const {
    pub(super) const C4U0: f64 = 102.0681;
    pub(super) const C5U0: f64 = 116.0837;
    pub(super) const C6U0: f64 = 130.0994;
    pub(super) const C7U0: f64 = 144.1150;
    pub(super) const C8U0: f64 = 158.1307;
    pub(super) const C9U0: f64 = 172.1463;
    pub(super) const C10U0: f64 = 186.1620;
    pub(super) const C11U0: f64 = 200.1776;
    pub(super) const C12U0: f64 = 214.1933;
    pub(super) const C13U0: f64 = 228.2089;
    pub(super) const C14U0: f64 = 242.2246;
    pub(super) const C15U0: f64 = 256.2402;
    pub(super) const C16U0: f64 = 270.2559;
    pub(super) const C16U1DC9: f64 = 268.2402;
    pub(super) const C16U1DT9: f64 = 268.2402;
    pub(super) const C17U0: f64 = 284.2715;
    pub(super) const C18U0: f64 = 298.2872;
    pub(super) const C18U1DC9: f64 = 296.2715;
    pub(super) const C18U1DT9: f64 = 296.2715;
    pub(super) const C18U2DC9DC12: f64 = 294.2559;
    pub(super) const C18U3DC6DC9DC12: f64 = 292.2402;
    pub(super) const C18U3DC8DT10DC12: f64 = 292.2402;
    pub(super) const C18U3DC9DC12DC15: f64 = 292.2402;
    pub(super) const C18U3DC9DT11DT13: f64 = 292.2402;
    pub(super) const C18U3DT9DT11DC13: f64 = 292.2402;
    pub(super) const C18U3DT9DT11DT13: f64 = 292.2402;
    pub(super) const C18U4DC6DC9DC12DC15: f64 = 290.2246;
    pub(super) const C19U0: f64 = 312.3028;
    pub(super) const C20U0: f64 = 326.3185;
    pub(super) const C20U1DC9: f64 = 324.3028;
    pub(super) const C20U1DC11: f64 = 324.3028;
    pub(super) const C20U2DC11DC14: f64 = 322.2872;
    pub(super) const C20U3DC5DC8DC11: f64 = 320.2715;
    pub(super) const C20U3DC8DC11DC14: f64 = 320.2715;
    pub(super) const C20U3DC11DC14DC17: f64 = 320.2715;
    pub(super) const C20U4DC5DC8DC11DC14: f64 = 318.2559;
    pub(super) const C20U4DC8DC11DC14DC17: f64 = 318.2559;
    pub(super) const C20U5DC5DC8DC11DC14DC17: f64 = 316.2402;
    pub(super) const C21U0: f64 = 340.3341;
    pub(super) const C22U0: f64 = 354.3498;
    pub(super) const C22U1DC13: f64 = 352.3341;
    pub(super) const C22U2DC13DC16: f64 = 350.3185;
    pub(super) const C22U3DC5DC13DC16: f64 = 348.3028;
    pub(super) const C22U4DC7DC10DC13DC16: f64 = 346.2872;
    pub(super) const C22U5DC7DC10DC13DC16DC19: f64 = 344.2715;
    pub(super) const C22U6DC4DC7DC10DC13DC16DC19: f64 = 342.2559;
    pub(super) const C23U0: f64 = 368.3654;
    pub(super) const C24U0: f64 = 382.3811;
    pub(super) const C24U1DC15: f64 = 380.3654;
    pub(super) const C24U2DC15DC18: f64 = 378.3498;
    pub(super) const C24U3DC12DC15DC18: f64 = 376.3341;
    pub(super) const C24U4DC9DC12DC15DC18: f64 = 374.3185;
    pub(super) const C24U5DC6DC9DC12DC15DC18: f64 = 372.3028;
    pub(super) const C24U6DC6DC9DC12DC15DC18DC21: f64 = 370.2872;
    pub(super) const C25U0: f64 = 396.3967;
    pub(super) const C26U0: f64 = 410.4124;
    pub(super) const C26U1DC17: f64 = 408.3967;
    pub(super) const C27U0: f64 = 424.4280;
    pub(super) const C28U0: f64 = 438.4437;
    pub(super) const C29U0: f64 = 452.4593;
    pub(super) const C30U0: f64 = 466.4750;
    pub(super) const C30U1DC21: f64 = 464.4593;
    pub(super) const C31U0: f64 = 480.4906;
    pub(super) const C32U0: f64 = 494.5063;
    pub(super) const C33U0: f64 = 508.5219;
    pub(super) const C34U0: f64 = 522.5376;
    pub(super) const C35U0: f64 = 536.5532;
    pub(super) const C36U0: f64 = 550.5689;
}
