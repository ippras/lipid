...
fn c16dc9() -> PolarsResult<()> {
    check!(C16U1C9, 268.2402);
    Ok(())
}

#[test]
fn c16dt9() -> PolarsResult<()> {
    check!(C16U1T9, 268.2402);
    Ok(())
}
...
fn c18dc9() -> PolarsResult<()> {
    check!(C18U1C9, 296.2715);
    Ok(())
}

#[test]
fn c18dt9() -> PolarsResult<()> {
    check!(C18U1T9, 296.2715);
    Ok(())
}

#[test]
fn c18dc9dc12() -> PolarsResult<()> {
    check!(C18U2C9C12, 294.2559);
    Ok(())
}

#[test]
fn c18dc6dc9dc12() -> PolarsResult<()> {
    check!(C18U3C6C9C12, 292.2402);
    Ok(())
}

#[test]
fn c18dc8dt10dc12() -> PolarsResult<()> {
    check!(C18U3C8T10C12, 292.2402);
    Ok(())
}

#[test]
fn c18dc9dc12dc15() -> PolarsResult<()> {
    check!(C18U3C9C12C15, 292.2402);
    Ok(())
}

#[test]
fn c18dc9dt11dt13() -> PolarsResult<()> {
    check!(C18U3C9T11T13, 292.2402);
    Ok(())
}

#[test]
fn c18dt9dt11dc13() -> PolarsResult<()> {
    check!(C18U3T9T11C13, 292.2402);
    Ok(())
}

#[test]
fn c18dt9dt11dt13() -> PolarsResult<()> {
    check!(C18U3T9T11T13, 292.2402);
    Ok(())
}

#[test]
fn c18dc6dc9dc12dc15() -> PolarsResult<()> {
    check!(C18U4C6C9C12C15, 290.2246);
    Ok(())
}
...
fn c20dc9() -> PolarsResult<()> {
    check!(C20U1C9, 324.3028);
    Ok(())
}

#[test]
fn c20dc11() -> PolarsResult<()> {
    check!(C20U1C11, 324.3028);
    Ok(())
}

#[test]
fn c20dc11dc14() -> PolarsResult<()> {
    check!(C20U2C11C14, 322.2872);
    Ok(())
}

#[test]
fn c20dc5dc8dc11() -> PolarsResult<()> {
    check!(C20U3C5C8C11, 320.2715);
    Ok(())
}

#[test]
fn c20dc8dc11dc14() -> PolarsResult<()> {
    check!(C20U3C8C11C14, 320.2715);
    Ok(())
}

#[test]
fn c20dc11dc14dc17() -> PolarsResult<()> {
    check!(C20U3C11C14C17, 320.2715);
    Ok(())
}

#[test]
fn c20dc5dc8dc11dc14() -> PolarsResult<()> {
    check!(C20U4C5C8C11C14, 318.2559);
    Ok(())
}

#[test]
fn c20dc8dc11dc14dc17() -> PolarsResult<()> {
    check!(C20U4C8C11C14C17, 318.2559);
    Ok(())
}

#[test]
fn c20dc5dc8dc11dc14dc17() -> PolarsResult<()> {
    check!(C20U5C5C8C11C14C17, 316.2402);
    Ok(())
}
...
fn c22dc13() -> PolarsResult<()> {
    check!(C22U1C13, 352.3341);
    Ok(())
}

#[test]
fn c22dc13dc16() -> PolarsResult<()> {
    check!(C22U2C13C16, 350.3185);
    Ok(())
}

#[test]
fn c22dc5dc13dc16() -> PolarsResult<()> {
    check!(C22U3C5C13C16, 348.3028);
    Ok(())
}

#[test]
fn c22dc7dc10dc13dc16() -> PolarsResult<()> {
    check!(C22U4C7C10C13C16, 346.2872);
    Ok(())
}

#[test]
fn c22dc7dc10dc13dc16dc19() -> PolarsResult<()> {
    check!(C22U5C7C10C13C16C19, 344.2715);
    Ok(())
}

#[test]
fn c22dc4dc7dc10dc13dc16dc19() -> PolarsResult<()> {
    check!(C22U6C4C7C10C13C16C19, 342.2559);
    Ok(())
}
...
fn c24dc15() -> PolarsResult<()> {
    check!(C24U1C15, 380.3654);
    Ok(())
}

#[test]
fn c24dc15dc18() -> PolarsResult<()> {
    check!(C24U2C15C18, 378.3498);
    Ok(())
}

#[test]
fn c24dc12dc15dc18() -> PolarsResult<()> {
    check!(C24U3C12C15C18, 376.3341);
    Ok(())
}

#[test]
fn c24dc9dc12dc15dc18() -> PolarsResult<()> {
    check!(C24U4C9C12C15C18, 374.3185);
    Ok(())
}

#[test]
fn c24dc6dc9dc12dc15dc18() -> PolarsResult<()> {
    check!(C24U5C6C9C12C15C18, 372.3028);
    Ok(())
}

#[test]
fn c24dc6dc9dc12dc15dc18dc21() -> PolarsResult<()> {
    check!(C24U6C6C9C12C15C18C21, 370.2872);
    Ok(())
}
