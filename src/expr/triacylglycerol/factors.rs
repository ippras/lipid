        ...
        let data_frame = df!(
            TRIACYLGLYCEROL => df!(
                STEREOSPECIFIC_NUMBERS1 => [
                    // fatty_acid!(C 12 U 1 { 3: C})?,
                    // fatty_acid!(C 14 U 1 { 5: C})?,
                    // fatty_acid!(C 15 U 1 { 6: T})?,
                    // fatty_acid!(C 15 U 1 { 6: C})?,
                    // fatty_acid!(C 16 U 1 { 7: T})?,
                    // fatty_acid!(C 16 U 1 { 7: C})?,
                    // fatty_acid!(C 17 U 1 { 8: T})?,
                    // fatty_acid!(C 17 U 1 { 8: C})?,
                    fatty_acid!(C 18 U 1 { 9: T})?,
                    fatty_acid!(C 18 U 1 { 9: C})?,
                    fatty_acid!(C 18 U 2 { 9: T, 12: T})?,
                    fatty_acid!(C 18 U 2 { 9: C, 12: C})?,
                    fatty_acid!(C 18 U 3 { 9: T, 12: T, 15: T})?,
                    fatty_acid!(C 18 U 3 { 9: C, 12: C, 15: C})?,
                    fatty_acid!(C 20 U 1 { 11: C})?,
                ],
